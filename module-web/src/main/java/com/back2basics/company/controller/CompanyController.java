...
public class CompanyController {
  ...
  @PostMapping
  public ResponseEntity<ResultResponse> createCompany(@RequestBody @Valid CompanyCreateCommand command) {
  ...
  public ResponseEntity<ResultResponse> deleteCompany(@PathVariable Long id) {
    ...
    return ResponseEntity.ok(ResultResponse.of(CompanyResponseCode.COMPANY_DELETE_SUCCESS, null));
  }
}
